...
-   Make sure you've got the connections between Git, GitHub, and RStudio worked out. Open your command line (either via terminal or through the terminal window in RStudio).

    -   Input the following two lines of code, replacing the account info as needed
