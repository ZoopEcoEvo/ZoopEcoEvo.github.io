...
As you work through these tutorials, keep in mind that the goal is to provide an introduction to R and how it can be used to work with data in this project folder workflow. This represents just the first step towards "fluency" (or even proficiency) in R. Consistent application of the material presented is required to maintain and improve your R skills.
